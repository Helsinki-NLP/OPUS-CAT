...
namespace OpusCatMtEngine
{
    public class AutoEditRuleCollection
    {
        ...
        internal async Task<Boolean> Delete(Boolean requireConfirmation = true)
        {
            string messageBoxText = String.Format(Properties.Resources.Rules_DeleteRuleCollectionConfirmation, this.CollectionName);
            var box = MessageBoxManager.GetMessageBoxStandard(
                Properties.Resources.Main_DeleteModelConfirmationTitle,
                messageBoxText,
                ButtonEnum.OkCancel);
