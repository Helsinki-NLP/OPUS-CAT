...
2. Download the plugin for your translation software and install it:
  ...
  - [Trados 2021](https://github.com/Helsinki-NLP/OPUS-CAT/releases/download/Trados-plugin-v1.0a/OpusCatTrados2021Plugin_v1.0.0.0a.zip): extract the zip file and double-click .sdlplugin file to install.
