...
2. Download the plugin for your translation software and install it:
  ...
  - OmegaT: Copy the plugin file [OpusCatTranslatePlugin-2.0.0.jar](https://github.com/Helsinki-NLP/OPUS-CAT/releases/download/omegat_plugin_v2/OpusCatTranslatePlugin-2.0.0.jar) to the *plugins* subfolder of the OmegaT installation folder (usually _C:\Program Files (x86)\OmegaT_).
