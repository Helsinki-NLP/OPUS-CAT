...
2. Download the plugin for your translation software and install it:
  - Trados Studio 2017, 2019 and 2021: Download the plugin from the [RWS AppStore](https://appstore.rws.com/language/app/opus-cat-nmt/1160/) and double-click .sdlplugin file to install.
  - Trados Studio 2022: This plugin is not yet available from the RWS AppStore, but you can download it from [the OPUS-CAT repository](https://github.com/Helsinki-NLP/OPUS-CAT/releases/tag/trados2022_plugin). Note that since this plugin has not been approved by RWS yet, you have to approve the loading of the plugin, when you start Trados.
